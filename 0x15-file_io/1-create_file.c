 ...
 * and writes the contents of `text_content` to it.
 * If the file already exists, it truncates it to zero length.
 * The file permissions are set to read and write for the owner.
 *
